...
/* fd00::fdff:ffff:ffff:1 is the gloabal addr and fd00::fdff:ffff:ffff:1 is a local addr */
static  uip_ipaddr_t ip_addr_root = { { 0xfd, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfd, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x01 } };
...
set_global_address(void)
{
  ...
  /* Mode 1 - 64 bits inline */
   uip_ip6addr(&ip_addr_root, UIP_DS6_DEFAULT_PREFIX, 0, 0, 0, 0, 0, 0, 1);
